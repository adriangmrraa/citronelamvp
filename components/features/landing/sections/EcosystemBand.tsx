        ...
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          {ecosystemWords.map((w) => (
            <span
              key={w}
              data-eco-word
              className="text-2xl sm:text-3xl font-bold text-zinc-600 hover:text-lime-300 transition-all duration-500 cursor-default hover:scale-110 hover:drop-shadow-[0_0_12px_rgba(163,230,53,0.4)]"
            >
              {w}
            </span>
          ))}
