...
const slides = [
  {
    id: 1,
    title: "Workshop de Extracción",
    subtitle: "Aprendé las mejores técnicas de Rosin",
    image: "/images/events/1.jpg",
    color: "from-lime-500/20"
  },
  {
    id: 2,
    title: "Citro-Expo 2026",
    subtitle: "El encuentro cannábico más grande del año",
    image: "/images/events/2.jpg",
    color: "from-blue-500/20"
  },
  {
    id: 3,
    title: "Cata de Variedades",
    subtitle: "Descubrí los terpenos más exclusivos",
    image: "/images/events/3.jpg",
    color: "from-purple-500/20"
  },
  {
    id: 4,
    title: "Clínica de Cultivo",
    subtitle: "Optimizá tu indoor con expertos",
        ...
        >
          ...
          >
            <h3 
              ...
              className="text-5xl md:text-7xl font-normal mb-1 tracking-wide leading-[1.1]" 
            >
              {slide.title}
            </h3>
            <p className="text-xl md:text-2xl text-white/80 font-medium tracking-wide mb-4 uppercase">
              {slide.subtitle}
            </p>
            <div>
