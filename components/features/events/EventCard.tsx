...
export function EventCard({ evt }: EventCardProps) {
  return (
    <Link href={`/events/${evt.id}`} className="block h-full group">
      <div 
        className="h-full min-w-[320px] w-full snap-center rounded-none overflow-hidden flex flex-col relative transition-all duration-500 bg-[#07120b] border border-[#a3e635]/20 group-hover:border-[#a3e635]/60 group-hover:shadow-[0_0_30px_rgba(163,230,53,0.1)]"
      >
        ...
        <div className="p-6 flex-1 flex flex-col justify-between space-y-6">
          <div className="space-y-6">
            <h3 
              className="text-3xl font-normal leading-tight text-white tracking-wide min-h-[4.5rem] flex items-center transition-colors group-hover:text-[#a3e635]"
