...
const slides = [
  {
    ...
    subtitle: "Controlá tu cultivo desde cualquier lugar",
  ...
  },
  {
    ...
    subtitle: "Optimizá tus recursos con IA",
  ...
  },
  {
    ...
    subtitle: "Analizá la evolución de tus plantas",
    image: "/images/dashboard/4.png",
    color: "from-lime-500/20"
  }
];

export const CultivoCarousel = () => {
...
export default CultivoCarousel;
